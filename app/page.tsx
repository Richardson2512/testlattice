        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{
            ...
            <p style={{
              ...
              Autonomous AI-driven test automation platform for web and mobile applications. 
          ...
          <div style={{
            ...
            {[
              ...
              },
              {
                ...
                description: 'Test both web applications and mobile apps with unified workflows and reporting.',
              },
              {
                icon: '⚡',
