...
export const metadata: Metadata = {
  ...
  description: 'Rihario is an AI-powered Vibe testing platform that uses autonomous agents to explore web applications in real-time. Detect visual bugs, accessibility issues, and security vulnerabilities without writing test scripts. Get comprehensive reports with video replays in 3 minutes.',
