...
export const metadata = {
    ...
    description: 'Discover why 1000+ indie hackers choose Rihario for AI-powered testing. No coding required. God Mode intervention. Self-healing tests. Built for solo developers, not enterprises.',
}

// Define sections for TOC
const tocSections = [
    { id: 'why-not-playwright', text: 'Why Rihario vs Playwright?' },
    { id: 'what-makes-different', text: 'What makes Rihario different?' },
...
export default function WhyRihario() {
    return (
        <main style={{ minHeight: '100vh', background: theme.bg.primary }}>
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "mainEntity": [
                            {
                                "@type": "Question",
                                "name": "Why should I use Rihario instead of Playwright or Cypress?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Rihario requires zero coding while Playwright and Cypress require you to write and maintain test scripts. Rihario uses AI to generate tests automatically and includes God Mode for when AI gets stuck, achieving 95% success rate vs 60% with traditional tools."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "What is God Mode in Rihario?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "God Mode is Rihario's unique feature where you can intervene when AI gets stuck during testing. Instead of test failing, you see the live browser, click the correct element, and the AI learns and continues automatically. This patent-pending technology achieves 95% test success rate."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "Can Rihario test my app without code?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Yes. Rihario uses AI (Llama 4 and Qwen) to analyze your pages and generate tests automatically. You describe what to test in plain English, and the AI handles all technical aspects including selectors, waits, and assertions."
                                }
                            },
                            {
                                "@type": "Question",
                            ...
                            {
                                "@type": "Question",
                                "name": "Is Rihario suitable for non-technical founders?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
            ...
            <section style={{ paddingTop: '180px', paddingBottom: '80px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                <div className="container" style={{ position: 'relative', zIndex: 1, maxWidth: '900px' }}>
                    <h1 style={{ fontSize: '3.5rem', marginBottom: '1.5rem', lineHeight: 1.1 }}>
                        Why Rihario? Because <span className="text-gradient">Testing Shouldn't Require a CS Degree.</span>
                    </h1>
            ...
            {/* Content Container with Right Sidebar TOC */}
            <div style={{ display: 'flex', maxWidth: '1400px', margin: '0 auto', padding: '0 2rem', paddingBottom: '5rem', gap: '3rem' }}>
                {/* Main Content */}
                <div className="why-rihario-content" style={{ flex: 1, maxWidth: '900px' }}>
                    ...
                    <section style={{ marginBottom: '5rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                            ...
                            <div style={{ padding: '1.5rem', background: '#d1fae5', borderRadius: '8px', color: '#065f46' }}>
                                <div style={{ fontWeight: 'bold', marginBottom: '0.5rem' }}>Rihario Solution</div>
    ...
    await expect(page).toHaveURL('/dashboard');
                            ...
                            <div className="glass-card" style={{ padding: '1.5rem', background: '#fff' }}>
                                <h4 style={{ marginBottom: '1rem', color: '#10b981' }}>The Rihario Way</h4>
                    ...
                    <section id="god-mode" style={{ marginBottom: '5rem' }}>
                        ...
                        <p style={{ fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '2rem', color: theme.text.secondary }}>
                            ...
                            <strong> In other tools, the test just fails. In Rihario, you enter God Mode.</strong>
                        </p>
