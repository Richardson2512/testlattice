...
export interface ProcessResult {
  ...
  // New Confidence & Exertion Model
  exertion?: TestRunExertion
  // New Vibe Engine Metadata
  vibeMeta?: VibeEngineMetadata
}

export interface TestRunExertion {
  totalSteps: number
  pagesVisited: number
  ...
  terminationReason: 'complete' | 'timeout' | 'limit_reached' | 'error' | 'blocked' | 'stopped_by_user'
}

export interface VibeEngineMetadata {
