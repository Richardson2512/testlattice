...
import type { ComprehensiveTestResults } from '../services/comprehensiveTesting'
...
export interface LLMAction {
  action: 'click' | 'type' | 'scroll' | 'navigate' | 'wait' | 'assert' | 'complete' | 'setViewport' | 'setDevice' | 'setOrientation' | 'check' | 'uncheck' | 'select' | 'goBack' | 'goForward' | 'submit'
  target?: string
  selector?: string
  value?: string
  description: string
