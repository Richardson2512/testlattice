                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                            ...
                            <div style={{ display: 'flex', gap: '1rem' }}>
                                ...
                                <div>
                                    ...
                                    <p style={{ color: theme.text.secondary, fontSize: '0.9rem', lineHeight: 1.6 }}>Rihario agents automatically adapt to DOM changes, reducing flaky test maintenance by over 85%.</p>
                                </div>
                            </div>
