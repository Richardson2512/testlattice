                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '4rem', marginBottom: '4rem' }}>
                    <div style={{ gridColumn: 'span 1' }}>
                        <div style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-inverse)' }}>
                            <Image src="/image/logo.png" alt="Rihario Logo" width={32} height={32} style={{ objectFit: 'contain' }} /> Rihario
                        </div>
                    ...
                    <div>
                        ...
                        <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                            <li><Link href="/about" style={{ color: 'var(--beige-300)', textDecoration: 'none' }}>About Us</Link></li>
                            <li><Link href="/why-rihario" style={{ color: 'var(--beige-300)', textDecoration: 'none' }}>Why Rihario?</Link></li>
                            <li><Link href="/glossary" style={{ color: 'var(--beige-300)', textDecoration: 'none' }}>Glossary</Link></li>
                            ...
                            <li><Link href="/faq" style={{ color: 'var(--beige-300)', textDecoration: 'none' }}>FAQ</Link></li>
